...
/**
 * The Global object is shared by all instances of the engine. It is used to centralize all JNDI
 * lookups.
 * 
...
public class Global
{
    ...
    public synchronized IOperationsHome getOperationsHome()
    {
        if (_operationsHome == null)
            _operationsHome = (IOperationsHome) findNamedObject(
                    "vlib/Operations",
    ...
    public synchronized Object findNamedObject(String name, Class expectedClass)
    {
        ...
        while (true)
        {
            try
            {
                ...
                if (raw == null)
                {
                    String message = "JNDI lookup of " + name
                            + " yielded null; expected instance of " + expectedClass.getName()
                            + ".";
            ...
            {
                throw new ApplicationRuntimeException("Object " + name + " is not type "
    ...
    /**
     * Invoked after any kind of naming or remote exception. Cached naming contexts and interfaces
     * are discarded.
     */
