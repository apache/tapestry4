...
public class HTMLWriter
{
	 ...
	 * by the constructor method, or created by the constructor method.
	 */

	protected PrintWriter writer;

	/**
	 * Set to true if the <code>OutputStream</code> constructor
	 * is used (in which case we create a <code>PrintWriter</code> of our own).
	 * When the <code>HTMLWriter</code> is sent {@link #close()} it will
	 * send <code>close()</code> to the <code>PrintWriter</code> as well.
	 *
	 */

	protected boolean closePrintWriter = false;
	...
	*  is created, which will be closed when the <code>HTMLWriter</code> is closed.
	*
	*/
	...
	public HTMLWriter(OutputStream stream)
	{
		...
		// We created the PrintWriter, so we're responsible for
		// closing it when we're done.

		closePrintWriter = true;
	}
	/**
	* Creates a new <code>HTMLWriter</code> around an existing <code>PrintWriter</code>.
	* The <code>PrintWriter</code> is not affected when
	* the <code>HTMLWriter</code> is sent {@link #close()}.
	*/
	...
	public HTMLWriter(PrintWriter writer)
	{
		...
		// When we close(), we don't close() the writer
		// as well.

	}
	/**
	* Creates an <code>HTMLWriter</code>
	* around an existing <code>PrintWriter</code>.
	*
	* @param writer The <code>PrintWriter</code> used by the <code>HTMLWriter</code>.
	* @param chainClose If true, sending {@link #close()}
	* to the <code>HTMLWriter</code> will send <code>close()</code>
	* to the <code>PrintWriter</code>.
	*/

	public HTMLWriter(PrintWriter writer, boolean chainClose)
	{
		this.writer = writer;
		closePrintWriter = chainClose;
	}
	/**
	* Creates a new <code>HTMLWriter</code> around an existing
	* <code>Writer</code>. A <code>PrintWriter</code> is created
	* to handle most of the work of printing. The underlying
	* <code>Writer</code> is not affected when the <code>HTMLWriter</code>
	* is sent <code>close()</code>.
	*
	* <p>This is the most useful constructor when using JSPs, since
	* the <code>out</code> variable on a JSP is an instance of
	* <code>javax.servlet.jsp.JspWriter</code>, which inherits from
	...
	*/
	...
	public HTMLWriter(Writer writer)
	{
		...
		// Close the PrintWriter (but no the Writer) when the HTMLWriter
		// is closed.
	...
	private void checkTagOpen()
	{
		if (!openTag)
			throw new IllegalStateException("A tag must be open before attributes " +
				"may be set in an HTMLWriter.");
	}
	/**
	* Closes this <code>HTMLWriter</code>. Any active elements are closed. The
	* <code>PrintWriter</code> may also be sent <code>close()</code>,
	* depending on how the <code>HTMLWriter</code> was constructed.
	*
	*/
	...
	*/
	...
	/**
	* Writes an HTML comment. Any open tag is first closed. The method takes care of
	...
	* of the contents is made (much like <code>printRaw()</code>.
	*
	*/
	...
	*/
	...
	/**
	* Forwards <code>flush()</code> to this <code>HTMLWriter</code>'s <code>PrintWriter</code>.
	*
	*/
	...
	*/
	...
	/**
	* Convienience method ... prints the string value of the Object if non-null. Does nothing
	...
	*/
	...
	/**
	* Formats an object and prints the result. <p>Closes any open tag.
	*
	* @see #print(String)
	*
	*/

	public void print(Format format, Object value)
	{
		print(format.format(value));
	}
	/**
	* Formats and prints a double value.
	*
	* <p>Closes any open tag.
	*
	* @see #print(String)
	*/
	...
	public void print(NumberFormat format, double value)
	{
		print(format.format(value));
	}
	/**
	* Formats and prints an integer.
	*
	* <p>Closes any open tag.
	*
	* @see #print(String)
	*/
	...
	public void print(NumberFormat format, int value)
	{
		print(format.format(value));
	}
	/**
	* Prints a boolean value as 'Yes' or 'No'. 
	*
	* <p>Closes any open tag.
	*
	* @see #print(boolean,String,String)
	*
	*/
	...
	public void print(boolean value, String yesValue, String noValue)
	{
		print(value ? yesValue : noValue);
	}
	/**
	...
	* makes this more effecient than <code>print()</code>. Does <em>nothing</em> if <code>value</code>
	* is null.
	*
	* <p>Closes any open tag.
	*
