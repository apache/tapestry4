...
import net.sf.tapestry.vlib.ejb.IBookHome;
import net.sf.tapestry.vlib.ejb.IMailMessageConstants;
import net.sf.tapestry.vlib.ejb.IPerson;
import net.sf.tapestry.vlib.ejb.IPersonHome;
import net.sf.tapestry.vlib.ejb.IPublisher;
import net.sf.tapestry.vlib.ejb.IPublisherHome;
...
/**
 *  Implementation of the {@link net.sf.tapestry.vlib.ejb.IOperations} 
