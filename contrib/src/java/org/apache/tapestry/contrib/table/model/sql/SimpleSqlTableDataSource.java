...
public class SimpleSqlTableDataSource implements ISqlTableDataSource
{
    ...
    private static final Log LOG = LogFactory.getLog(SimpleSqlTableDataSource.class);
     ...
     *      SimpleTableState)
     */
    public ResultSet getCurrentRows(SqlTableColumnModel objColumnModel, SimpleTableState objState)
        throws SQLException
    {
    ...
    {
        String strQuery = "SELECT " + generateColumnList(objColumnModel) + " FROM " + getTableName() + " "
                + generateWhereClause() + generateOrderByClause(objState.getSortingState())
    ...
    {
        String strQuery = "SELECT COUNT(*) FROM " + getTableName() + " " + generateWhereClause();
