...
public interface IMultiplePropertySelectionRenderer
{
    ...
    public void beginRender(MultiplePropertySelection component, IResponseWriter writer, IRequestCycle cycle)
    ...
    public void endRender(MultiplePropertySelection component, IResponseWriter writer, IRequestCycle cycle)
    throws RequestCycleException;
}
