...
import net.sf.tapestry.contrib.render.ComponentAddress;
 ...
 *
 */
public class SimpleTableColumnComponent extends BaseComponent 
    implements ISimpleTableColumnRenderer, PageDetachListener
{
    ...
    public void columnSelected(IRequestCycle objCycle) {
        ...
        if (strColumnName.equals(objState.getSortColumn()))
            ...
            objState.setSortColumn(strColumnName, ITableSortingState.SORT_ASCENDING);
    }
