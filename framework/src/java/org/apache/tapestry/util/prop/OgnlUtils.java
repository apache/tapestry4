 ...
 * <p>
 * This has been temporarily hacked for Tapestry 3.1. It's not a good solution, because it only
 * really supports a single class loader, which could be a problem if the Tapestry framework is
 * loaded by the system class loader.
 * 
 * @author Howard Lewis Ship
 * @since 2.2
 * @deprecated To be removed in 3.2; use {@link org.apache.tapestry.services.ExpressionEvaluator}
 *             service instead.
 */
...
public class OgnlUtils
{
        ...
        if (result == null)
        {
            ...
            catch (Exception ex)
            {
                throw new ApplicationRuntimeException(Tapestry.format(
                        "OgnlUtils.unable-to-parse-expression",
                        expression), ex);
            }
    ...
    /**
     * Parses and caches the expression and uses it to update the target object with the provided
     * value.
     * 
     * @throws ApplicationRuntimeException
     *             if the expression can not be parsed, or the target can not be updated.
     */
     ...
     * @throws ApplicationRuntimeException
     *             if the target can not be updated.
     */
    ...
    /**
     * @return true if the parsed expression evaluates to a constant or literal value
     * @since 3.1
     */
     ...
     * 
     * @throws ApplicationRuntimeException
     *             if the expression can not be parsed, or the value not obtained from the object.
     */
