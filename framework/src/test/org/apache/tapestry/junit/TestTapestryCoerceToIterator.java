...
public class TestTapestryCoerceToIterator extends TapestryTestCase
{
    ...
    public void testByteArray()
    {
        ...
        { new Byte("1"), new Byte("3"), new Byte("7") };
    ...
    public void testCharArray()
    {
        ...
        { new Character('b'), new Character('k') };
    ...
    public void testIntArray()
    {
        ...
        { new Integer(55), new Integer(12873), new Integer(12) };
    ...
    public void testLongArray()
    {
        ...
        { new Long(27l), new Long(191933939l) };
    ...
    public void testDoubleArray()
    {
        ...
        { new Double("18.55"), new Double(" -97.123") };
