...
public class Body extends AbstractComponent
{
    ...
    *
    *  <p>Returns a String that can be used to represent
    *  the preloaded image in a JavaScript function.
	*
	*/

	public String addImageInitialization(String imageName, String URL)
	{
		String variableName;
        String result;
     ...
     *  {@link Script} component or {@link ScriptGenerator} class
     * (which is actually what {@link Rollover} does).
	 *
