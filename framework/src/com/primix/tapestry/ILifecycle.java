 ...
 *  overiding {@link IComponent#render(IResponseWriter, IRequestCycle)} is that
 ...
 *
 *  <p>This interface is deprecated as of 1.0.5, and will be removed in 1.1.  You
 *  should use the page listener interfaces in {@link com.primix.tapestry.event}
 *  instead.  The implementation of {@link AbstractComponent} includes 
 *  all of these methods, and adds listeners for them in
 * {@link AbstractComponent#finishLoad()}.
 *
 *  @author Howard Ship
 *  @version $Id$
