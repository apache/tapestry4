...
public class Body extends AbstractComponent
{
	...
	*/
    ...
    /**
     *  Adds other initialization, in the form of additional statements
     *  to execute from the body's <code>onLoad</code> event
     *  handler.  The final script generated by the Body component
     *  will add indentation before the statement and a semicolon after.
     *
     */

    public void addOtherInitialization(String statement)
    {
        if (otherInitialization == null)
            otherInitialization = new ArrayList();

        otherInitialization.add(statement);
    }
