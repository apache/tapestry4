...
public interface IResponseWriter
{
    ...
    /**
     * Changes the compressed property, but returns the value before
     * the * change. This is used by clients that need to temporarily
     * turn * compression on, but want to restore it back to it's
     * prior value.
     */
    ...
    /**
     *  Changes the compressed attribute.  When the <code>IResponseWriter</code> is compressed,
     *  it does not perform any indentation.  This is useful for elements
     *  where exact spacing counts.
     *
