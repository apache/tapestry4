...
"dojo.widget.ContentPane",dojo.widget.HtmlWidget,function(){this._styleNodes =  [];this._onLoadStack = [];this._onUnloadStack = [];this._callOnUnload = false;this._ioBindObj;this.scriptScope;this.bindArgs = {};}, {isContainer: true,adjustPaths: true,href: "",extractContent: true,parseContent:true,cacheContent:true,preload: false,refreshOnShow: false,handler: "",executeScripts: false,scriptSeparation: true,loadingMessage: "Loading...",isLoaded: false,"class": "dojoContentPane",templateCssPath: dojo.uri.moduleUri("dojo.widget", "templates/ContentPane.css"),postCreate: function(args, frag, parentComp){dojo.html.addClass(this.domNode, this["class"]);if (this.handler!==""){this.setHandler(this.handler);}
