...
"dojo.widget.Spinner",null,{_typamaticTimer: null,_typamaticFunction: null,_currentTimeout: this.defaultTimeout,_eventCount: 0,defaultTimeout: 500,timeoutChangeRate: 0.90,templatePath: dojo.uri.moduleUri("dojo", "widget/templates/Spinner.html"),templateCssPath: dojo.uri.moduleUri("dojo", "widget/templates/Spinner.css"),incrementSrc: dojo.uri.moduleUri("dojo", "widget/templates/images/spinnerIncrement.gif"),decrementSrc: dojo.uri.moduleUri("dojo", "widget/templates/images/spinnerDecrement.gif"),_handleKeyEvents: function( evt){if(!evt.key){ return; }
