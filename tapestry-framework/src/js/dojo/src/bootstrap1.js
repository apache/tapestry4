...
dojo.locale  = djConfig.locale;dojo.version = {major: 0, minor: 3, patch: 1, flag: "+",revision: Number("$Rev: 6392 $".match(/[0-9]+/)[0]),toString: function(){with(dojo.version){return major + "." + minor + "." + patch + flag + " (" + revision + ")";}}}
