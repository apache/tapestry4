...
this.decorateInput(elms[i], title);dojo.event.browser.addListener(elms[i], "onfocus", dojo.lang.hitch(this, this.nodeFocused));dojo.event.browser.addListener(elms[i], "onblur", dojo.lang.hitch(this, this.nodeBlurred));dojo.event.browser.addListener(elms[i], "onkeyup", dojo.lang.hitch(this, this.nodeKeyPressed));}
