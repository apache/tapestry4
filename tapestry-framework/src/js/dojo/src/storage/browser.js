...
dojo.raise("dojo.storage.browser.FileStorageProvider._removeJava(): " + msg);}},_writeApplet: function(){var archive = dojo.uri.dojoUri("DojoFileStorageProvider.jar").toString();var tag = "<applet "
