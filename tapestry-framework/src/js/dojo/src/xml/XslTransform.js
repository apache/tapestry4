...
dojo.provide("dojo.xml.XslTransform");dojo.xml.XslTransform = function(xsltUri, loadAsync){dojo.debug("XslTransform is supported by Internet Explorer and Mozilla, with limited support in Opera 9 (no document function support).");var IS_IE = dojo.render.html.ie;var ACTIVEX_DOMS = [
...
xsltDocument.async = (!!loadAsync);xsltDocument.load(xsltUri);if(IS_IE){var xslt = new ActiveXObject(getActiveXImpl(ACTIVEX_TEMPLATES));xslt.stylesheet = xsltDocument;  
