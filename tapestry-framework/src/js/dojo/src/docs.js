...
getMeta: function( selectKey,  pkg,  name,  callback,  id){
...
_withPkg: function( type,  data,  evt,  input,  newType){
...
_gotMeta: function( type,  data,  evt){
...
getSrc: function( selectKey,  name,  callback,  id){
...
getDoc: function( selectKey,  name,  callback,  id){
...
_gotDoc: function( type,  data,  evt,  input){
...
getPkgDoc: function( selectKey,  name,  callback){
...
getPkgInfo: function( selectKey,  name,  callback){
...
_getPkgInfo: function( type,  data,  evt){
...
getInfo: function( selectKey,  name,  callback){
...
_getInfo: function( type,  data,  evt,  input){
...
OLD_getPkgMeta: function( input){
dojo.debug("_getPkgMeta(" + input.name + ")");
input.type = "pkgmeta";
dojo.docs._buildCache(input);
},
_onDocSearch: function( input){
var _this = this;
...
_onDocSearchFn: function( type,  data,  evt){
...
_onPkgResults: function( type,  data,  evt,  input){
...
_onDocResults: function( type,  data,  evt,  input){
...
_onDocSelectFunction: function( input){
...
_onDocSelectPackage: function( input){
...
_onDocSelectResults: function( type,  data,  evt,  input){
...
savePackage: function( callbackObject,  callback,  parameters){
...
functionPackages: function( selectKey,  name,  callback,  input){
...
_functionPackages: function( type,  data,  evt){
