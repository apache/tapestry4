...
import org.apache.tapestry.test.RequestDescriptor;
...
public class TestRequestDescriptor extends HiveMindTestCase
{
    ...
    public void testAdd()
    {
        ...
        assertListsEqual(new String[] { "burns" }, d.getParameterValues("frank"));
    }
    ...
    public void testGetNames()
    {
        ...
        assertListsEqual(new String[] { "flintstone", "rubble" }, names);
    }
    ...
    public void testAddMultiple()
    {
        ...
        assertListsEqual(
            new String[] { "fred", "wilma", "dino" },
            d.getParameterValues("flintstone"));
    }
