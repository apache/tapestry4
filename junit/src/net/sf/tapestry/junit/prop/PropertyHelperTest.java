	...
	extends TestCase
{
	...
	public void testSimpleStringProperty()
	{
		...
		assertEquals("Check stringProperty.", 
					 helper.get(this, "stringProperty"), getStringProperty());
	}
	...
	public void testSimpleIntProperty()
	{
		...
		assertEquals("Check intProperty.",
	...
	public void testPropertyPath()
	{
		...
		assertEquals("Check objectProperty.intProperty.",
	...
	public void testSplitPropertyPath()
	{
		...
		String[] splitPath = PropertyHelper.splitPropertyPath("objectProperty.intProperty");
		
		assertEquals(new Integer(bean2.intProperty),
					 helper.getPath(bean, splitPath));
	}
	...
	public void testPathPropertyWrite()
	{
		...
		assertEquals("Check objectProperty.stringProperty.",
					 "Beta", bean2.getStringProperty());
	}
	...
	public void testSplitPathPropertyWrite()
	{
		...
		helper.setPath(bean1, new String[] { "objectProperty", "stringProperty" },
					   "Gamma");
		
		assertEquals("Check objectProperty.stringProperty.",
					 "Gamma", bean2.getStringProperty());
	}
	...
	public void testUnknownPropertyPath()
	{
		...
		catch (MissingPropertyException ex)
		{
			...
			assertEquals("Exception propertyPath.", 
						 "objectProperty.fooProperty", ex.getPropertyPath());
		}
	}
	...
	public void testGetAccessorsStandard()
	{
		...
		assertNotNull("Accessors contains stringProperty.", accessors.get("stringProperty"));
	...
	public void testGetAccessorsPublicBean()
	{
		...
		assertNotNull("Accessors contains class.", accessors.get("class"));
		assertNotNull("Accessors contains objectProperty.", accessors.get("objectProperty"));
		assertNotNull("Accessors contains intProperty.", accessors.get("intProperty"));
	}
	...
	public void testGetUnknownAccessor()
	{
		...
		assertNull("No accessor for unknown property foo.", helper.getAccessor(this, "foo"));
	}
