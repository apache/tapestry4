...
implements ICommand
{
    ...
    public void run(String[] args)
    {
        ...
        for (i = 1; i < args.length; i++)
        {
            ...
            if (arg.equals("-help"))
            {
                System.out.println("Usage: com.primix.jbe.Util canonicalize " +
                    "[-help] [-classpath] [-root directory]  directory...");	
                System.exit(0);
            }			
            ...
            {
                if (++i >= args.length)
                    Util.error("Must specify root directory after -root option.");
    ...
    private void emitPath(String path)
    {
        ...
        {
            Util.error(e.getMessage() + " for " + path + ".");
        }
